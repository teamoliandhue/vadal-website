...
export const PRODUCT_SCREENS: Record<string, Record<string, string>> = {
  "action-planning": {
    ...
    "Action Plan Board (drag-and-drop)": "action-plan-board-drag-and-drop",
  ...
  "alumni": {
    ...
    "Boomerang Candidate Pipeline": "boomerang-candidate-pipeline",
  ...
  "benchmark-intelligence": {
    ...
    "Driver-Level Peer Gap View": "driver-level-peer-gap-view",
    "Industry & Region Filter Panel": "industry-and-region-filter-panel"
  },
  ...
  "feedback-intelligence": {
    ...
    "Sentiment Intensity Heatmap": "sentiment-intensity-heatmap",
  ...
  "leadership-intelligence": {
    ...
    "High-Potential Talent View": "high-potential-talent-view",
  ...
  "sentiment-intelligence": {
    ...
    "Team-Level Sentiment Heatmap": "team-level-sentiment-heatmap",
    "Theme & Emotion Cluster View": "theme-and-emotion-cluster-view"
  },
  "skills-intelligence": {
    "Capability Gap Dashboard": "capability-gap-dashboard",
    "Individual Development Path View": "individual-development-path-view",
  ...
  "workforce-planning": {
    ...
    "Real-Time Plan Tracking View": "real-time-plan-tracking-view",
    "Scenario Modeling Dashboard": "scenario-modeling-dashboard",
    "Skills-Aware Headcount Plan": "skills-aware-headcount-plan"
  }
};
